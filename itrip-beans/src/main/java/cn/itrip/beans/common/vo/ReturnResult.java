package cn.itrip.beans.common.vo;
...
public class ReturnResult implements Serializable {
     ...
     * @return
     */
    public static ReturnResult error(Boolean success, String errorCode,
                                     String msg) {
     ...
     * 异常响应
     *
     * @param success   是否成功标示,成功为 true;失败为 false,一般情况下为 tru
     *                  e
     * @param errorCode 内部错误码
     * @param msg       错误信息
     * @param data      数据
    ...
    public static ReturnResult error(Boolean success, String errorCode,
        ...
        return new ReturnResult(String.valueOf(success), errorCode, msg,
                data);
    }


    private ReturnResult(String success, String errorCode, String msg,
                         Object data) {
